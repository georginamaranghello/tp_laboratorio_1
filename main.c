        ...
        switch(opcion)
        {
            ...
            case 5:
                 ...
                 if (flagA == 1 && flagB == 1)
                {
                    ...
                    printf("\nla division de %f / %f = %f", numeroUno, numeroDos, resultado);
            ...
            case 6:
                 ...
                 if (flagA == 1 && flagB == 1)
                {
                    ...
                    printf("\nla multiplicacion de %f * %f = %f", numeroUno, numeroDos, resultado);
            ...
            case 7:
                ...
                if (flagA==1)
                {
                    ...
                    printf("\nEl factorial de %f = %f ", numeroUno, resultado);
                }
